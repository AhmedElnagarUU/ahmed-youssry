...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-slate-900 border-t border-blue-500/20 mt-12 starry-bg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Home
                </a>
              </li>
              <li>
                <a href="#skills" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Services
                </a>
              </li>
              <li>
                <a href="#workflow" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Projects
                </a>
              </li>
              <li>
                <a href="#projects" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  Clients
                </a>
              </li>
            </ul>
